...
min_mum, max_mum, average  = get_min_max_avg([-100.0,100.001, -1000000.9, 25.98, 0.1 , 99999999.099])
print(f'The values of minimum are {min_mum: .2f} and maximum are {max_mum: .2f} and the average is {average: .2f}')
